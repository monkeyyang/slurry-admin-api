...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'yoke-work' => [
            'driver' => 'mysql',
            'url' => env('YOKE_DATABASE_URL'),
            'host' => env('YOKE_DB_HOST', '127.0.0.1'),
            'port' => env('YOKE_DB_PORT', '3306'),
            'database' => env('YOKE_DB_DATABASE', 'forge'),
            'username' => env('YOKE_DB_USERNAME', 'forge'),
            'password' => env('YOKE_DB_PASSWORD', ''),
            'unix_socket' => env('YOKE_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
